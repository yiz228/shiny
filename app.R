...
ui <- page_fluid(
  ...
  h2("WIC Toddler Overweight Prevalence Explorer"),
  ...
  tabsetPanel(
    tabPanel(
      ...
      p("Go to the Data Visualization tab to select a year, choose a plot type, and select race/ethnicity groups. The visualization and summary will update based on the selected options."),
